...
export default async function Home() {
  ...
  if (!session) return <div className="flex items-center justify-center flex-col h-screen gap-8 ">
    <div className="h-2/4 flex flex-col justify-between w-6/12">
      <div className="space-y-8 text-white">
        <h1 className="text-5xl font-bold">Embrace Your Feelings, Transform Your Days</h1>
        <h1 className="text-2xl font-bold">Sign in to unlock insights into your mood and wellbeing</h1>
      </div>

      <div className="flex w-2/4 justify-between border rounded-full  bg-white">
